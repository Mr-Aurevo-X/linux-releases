...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/MrAurevoX-Kit-v2.0.2/MrAurevoX_Kit-2.0.2.tar.gz
tar -xzf MrAurevoX_Kit-2.0.2.tar.gz
cd MrAurevoX_Kit-2.0.2
bash install.sh
```
