...
| **MrAurevoX Kit** | [`MrAurevoX-Kit-v0.1.0`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/MrAurevoX-Kit-v0.1.0) | `tar.gz` + `install.sh` |
...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/MrAurevoX-Kit-v0.1.0/MrAurevoX_Kit-0.1.0.tar.gz
tar -xzf MrAurevoX_Kit-0.1.0.tar.gz
cd MrAurevoX_Kit-0.1.0
bash install.sh
```

Recherche, pipette, renommage regex, hash SHA-256/512, images. Launcher : `mraurevox-kit`.  
