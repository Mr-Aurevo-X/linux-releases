...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.16`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/crypto-tracker-v1.2.16) | zips Mail / Binaire / Portable |
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.13`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/Gest_Linux_Pro-v1.4.13) | `tar.gz` + `install.sh` (`.deb` optionnel) |
...
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v1.2.16/CryptoTracker-Linux-Mail-*.zip
...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/Gest_Linux_Pro-v1.4.13/Gest_Linux_Pro-1.4.13.tar.gz
tar -xzf Gest_Linux_Pro-1.4.13.tar.gz
cd Gest_Linux_Pro-1.4.13
bash install.sh
```
...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/MrAurevoX-Kit-v1.1.0/MrAurevoX_Kit-1.1.0.tar.gz
