...
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.12`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/Gest_Linux_Pro-v1.4.12) | **Flatpak uniquement** (plus de tar.gz ici) |
