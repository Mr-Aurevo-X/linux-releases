...
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.11`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/Gest_Linux_Pro-v1.4.11) | **Flatpak uniquement** (plus de tar.gz ici) |
...
wget -O org.mraurevox.GestLinuxPro.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/Gest_Linux_Pro-v1.4.11/org.mraurevox.GestLinuxPro.flatpak
