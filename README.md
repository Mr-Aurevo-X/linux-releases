...
| **Gest Linux Pro** | [`Gest_Linux_Pro-v2.2.0`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/Gest_Linux_Pro-v2.2.0) | **Flatpak uniquement** (plus de tar.gz ici) |
