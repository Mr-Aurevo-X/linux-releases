...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v2.0.15`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/crypto-tracker-v2.0.15) | zips Binaire / Portable |
...
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v2.0.15/CryptoTracker-Linux-Binaire-20260920.zip
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v2.0.15/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.
