...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.1`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/crypto-tracker-v1.2.1) | zips Mail / Binaire / Portable |
...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v1.2.1/CryptoTracker-Linux-Mail-20260815.zip
