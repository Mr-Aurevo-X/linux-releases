...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.12`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/crypto-tracker-v1.2.12) | zips Mail / Binaire / Portable |
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.11`](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/Gest_Linux_Pro-v1.4.11) | `tar.gz` + `install.sh` (`.deb` optionnel) |
...
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v1.2.12/CryptoTracker-Linux-Mail-*.zip
unzip -o CryptoTracker-Linux-Mail-*.zip
...
```bash
unset SSL_CERT_FILE SSL_CERT_DIR REQUESTS_CA_BUNDLE CURL_CA_BUNDLE
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v1.2.12/CryptoTracker-Linux-Binaire-20260815.zip
...
- `CryptoTracker-Linux-Mail-*.zip` — léger, pas de graphes (glibc Ubuntu 22.04+)
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-releases/releases/download/crypto-tracker-v1.2.12/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.

## Gest Linux Pro 1.4.11

**© 2026 Mr-Aurevo-X** · GPL-3.0-or-later · 100 % local (sauf vérif MAJ GitHub, désactivable)

```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/Gest_Linux_Pro-v1.4.11/Gest_Linux_Pro-1.4.11.tar.gz
tar -xzf Gest_Linux_Pro-1.4.11.tar.gz
cd Gest_Linux_Pro-1.4.11
bash install.sh
```
...
```bash
curl -fL -O https://github.com/Mr-Aurevo-X/linux-releases/releases/download/MrAurevoX-Kit-v1.0.0/MrAurevoX_Kit-1.0.0.tar.gz
tar -xzf MrAurevoX_Kit-1.0.0.tar.gz
cd MrAurevoX_Kit-1.0.0
bash install.sh
```
